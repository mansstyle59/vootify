...
function NowPlayingHero({
  ...
  return (
    ...
    >
      ...
      <SafeImage src={coverUrl} alt="" referrerPolicy="no-referrer" className="absolute inset-0 w-full h-full object-cover opacity-20 blur-[60px] scale-[2]" />
      <div
...
const RadioPage = () => {
  ...
  return (
    <div className="pb-20 max-w-7xl mx-auto">
      ...
      >
        <div className="px-4 md:px-8 pb-3" style={{ paddingTop: "calc(max(1.5rem, env(safe-area-inset-top, 0px)) + var(--ai-banner-h, 0px) + var(--pwa-top-extra, 0px))" }}>
