  ...
  return (
    <div className="p-4 md:p-8 pb-32 max-w-7xl mx-auto">
      ...
      <p className="text-muted-foreground mb-6">
        Vos stations radio ajoutées manuellement
      </p>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h2 className="text-xl font-display font-semibold text-foreground mb-2">Aucune station</h2>
          <p className="text-muted-foreground">Ajoutez des stations radio depuis la page Ajouter.</p>
        </div>
      )}
    </div>
  );
