  ...
  return (
    <div className="pb-20 animate-fade-in">
      ...
      <motion.div style={{ y: bgY }} className="relative h-80 overflow-hidden">
        {coverUrl ? (
          <img src={coverUrl} alt={artistName} referrerPolicy="no-referrer" className="w-full h-full object-cover scale-110 blur-sm" />
        ) : (
        ...
        <div className="absolute bottom-6 left-4 right-4 flex items-end gap-4">
          <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-background shadow-2xl flex-shrink-0">
            {coverUrl ? (
              <img src={coverUrl} alt={artistName} referrerPolicy="no-referrer" className="w-full h-full object-cover" />
            ) : (
            ...
            {albumsList.map((album, i) => (
              ...
              >
                <div className="w-36 h-36 rounded-xl overflow-hidden bg-secondary mb-2 shadow-lg group-hover:shadow-xl transition-shadow">
                  {album.coverUrl ? (
                    <img src={album.coverUrl} alt={album.title} referrerPolicy="no-referrer" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
                  ) : (
            ...
            {singlesList.map((single, i) => (
              ...
              >
                <div className="w-28 h-28 rounded-xl overflow-hidden bg-secondary mb-2 shadow-lg group-hover:shadow-xl transition-shadow">
                  {single.coverUrl ? (
                    <img src={single.coverUrl} alt={single.title} referrerPolicy="no-referrer" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
                  ) : (
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary/20 to-primary/5">
