...
const LibraryPage = () => {
  ...
  return (
    <div className="pb-20 max-w-7xl mx-auto relative">
      ...
      >
        <div className="relative px-5 md:px-9 pb-3" style={{ paddingTop: "calc(max(2rem, env(safe-area-inset-top, 0px)) + var(--ai-banner-h, 0px) + var(--pwa-top-extra, 0px))" }}>
          {isOffline && (
            <div
