    ...
    try {
      ...
      for (const t of allTracks) {
        ...
        if (local) {
          ...
          notFound++;
          // Local-only: skip tracks not found in library
        }
      }
...
const AddContentPage = () => {
  ...
  return (
    <div className="pb-20 max-w-2xl mx-auto" style={{ paddingTop: "calc(env(safe-area-inset-top, 0px) + var(--ai-banner-h, 0px) + var(--pwa-top-extra, 0px) + 1.5rem)" }}>
      {/* Header */}
