...
export interface CustomSection {
  ...
  type?: "songs" | "albums" | "playlists"; // default: "songs"
  albumIds?: string[]; // custom_albums UUIDs or derived keys
  playlistIds?: string[]; // playlists UUIDs
}
...
const DEFAULT_SECTIONS: HomeSection[] = [
  ...
  { id: "top_artists", title: "Top Artistes 🏆", visible: true, order: 1 },
  { id: "most_played", title: "Les plus écoutés 🔥", visible: true, order: 2 },
  { id: "recently_listened", title: "Écoutés récemment 🕐", visible: true, order: 3 },
  { id: "recommended", title: "Recommandés pour vous ✨", visible: true, order: 4 },
  { id: "artists", title: "Artistes 🎤", visible: true, order: 5 },
  { id: "albums", title: "Albums 💿", visible: true, order: 6 },
];
